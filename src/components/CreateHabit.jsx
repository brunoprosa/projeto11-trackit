...
export default function CreateHabit({hidden, setHidden, habits, setHabits}){
    ...
    return(
        <Container data-test="habit-create-btn" hidden={hidden}>
            <NewHabit onSubmit={createH}>
                ...
                <>
                    <Cancel data-test="habit-create-cancel-btn" onClick={() => setHidden(hidden ? false : true)}>Cancelar</Cancel>
                    <Save data-test="habit-create-save-btn" type="submit">Salvar</Save>
                </>
            </NewHabit>
        </Container>
    )
